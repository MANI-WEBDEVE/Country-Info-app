...
const About = () => {
    return (
        <section className="w-full  bg-black h-full  ">
            ...
            <div className="flex flex-wrap justify-start ml-[20px] mr-[20px] md:ml-[84px] md:mr-[84px] items-center p-4">
                {country.map((item, index) => (
                    <div className="w-full md:w-1/2 lg:w-1/3 p-6 " key={item.id}>
                        <div className="bg-black rounded-lg shadow-2xl p-4 border-2 border-white hover:shadow hover:shadow-white transition-all duration-500 ease-in-out ">
                            ...
                            <p className="text-white">
                                Fact: <span className="text-white font-medium tracking-tighter">{item.fact}</span>
                            </p>
                        </div>
                    </div>
                ))}
